...
namespace Scheduler
{
    ...
    public class GA
    {
        ...
        private void CreateGenomes()
        {
            ...
            for (int i = 0; i < m_populationSize; i++)
            {
                Index = (int)RandomGen.Next(population.Count);
        ...
        static Random RandomGen = new Random(DateTime.Now.Millisecond);
        ...
        public void GetBest(out double[] values, out int fitness)
        {
